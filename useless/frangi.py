"""
Note:
    This is taken directly from skikit-image 0.13dev chain.
    A single line was altered to refer to a local file.
    Upgrade to 0.13 when possible
"""
import numpy as np
...
def _frangi_hessian_common_filter(image, scale_range, scale_step,
    ...
    """
    # import from global v0.12 skimage.feature and hope it works
